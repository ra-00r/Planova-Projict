...
async function doSignup() {
  ...
  alert("تم إنشاء الحساب ✅ افحصي الإيميل للتأكيد.");
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  ["loginModal","signupModal","taskModal","examModal","planModal","gradeModal"].forEach(id => {
